...
function InitMap() {
	...
	// Set up the map
	map = new L.Map('map', {center: [7.5, 7], zoom: 3, minZoom: 2, maxZoom: 6, markerZoomAnimation: false, attributionControl: false, crs: crsChernarus});

	// Create tile layer
	//heatmapLayer.addData(tiles);
	map.addLayer(tiles);
}
